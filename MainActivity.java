...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        String asunto = "Confirmación de su orden";
        String direccion = "mvazquez_tl@hotmail.com";
        composeEmail(direccion, asunto, message);
    ...
    /**
     * This method displays the given price on the screen y ya no se utilizo porque
     * ahora se muestra el detalle de la orden no solo el precio
     */


    private void displayPrice(int number) {
        TextView priceTextView = (TextView) findViewById(R.id.order_sumary_text_view);
    ...
    private void displayMessage(String message) {
        TextView orderSumaryTextView = (TextView) findViewById(R.id.order_sumary_text_view);
    ...
    /**
    *
    * Este metodo se va a sustituir por la integración del codígo al método de incremento y decremento **/
